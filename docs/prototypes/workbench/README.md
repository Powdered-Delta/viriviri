...
and recommendations retain their vertical order in compact rows above it;
candidate words expand below the preedit text. Its preview puts Shift and symbol
mode on the ZXC row, keeps `中/英`, comma, period, a wide centered
